CREATE TABLE Acquisto (
 id_acquisto INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
 data DATE,
 totale FLOAT(10),
 id_indirizzo INT(10),
 id_utente INT(10)
...
CREATE TABLE Carta_Di_Credito (
 id_carta INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Indirizzo (
 id_indirizzo INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
 id_utente INT(10),
 citta VARCHAR(50),
 via VARCHAR(50),
 CAP CHAR(5),
...
CREATE TABLE Scarpa (
 id_scarpa INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
 sesso CHAR(1),
 prezzo FLOAT(10),
 id_marca INT(10),
 foto CHAR(10)
...
CREATE TABLE Taglia (
 id_taglia INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
 taglia_uk FLOAT(10),
 taglia_eu FLOAT(10),
 taglia_us FLOAT(10),
 taglia_jp FLOAT(10)
...
CREATE TABLE Utente (
 id_utente INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
 email VARCHAR(50),
 password VARCHAR(50),
